...
const EN: GuideTranslations = {
  ...
  wechatSaving: 'Saving...',
  doneTitle: 'All set',
  doneSubtitle: 'You\'re all set to start using Halo right away',
  doneButton: 'Start',
  back: 'Back',
  next: 'Next',
  skip: 'Skip for now',
...
const JA: GuideTranslations = {
  ...
  wechatSaving: '保存中...',
  doneTitle: '準備完了',
  doneSubtitle: 'Haloを使い始める準備ができました',
  doneButton: '使い始める',
  back: '戻る',
  next: '次へ',
  skip: '今はスキップ',
...
const DE: GuideTranslations = {
  ...
  doneSubtitle: 'Sie sind bereit, Halo zu nutzen',
...
const ES: GuideTranslations = {
  ...
  doneSubtitle: 'Estás listo para empezar a usar Halo',
...
const FR: GuideTranslations = {
  ...
  doneSubtitle: 'Vous êtes prêt à utiliser Halo',
